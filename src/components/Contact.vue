<template lang="html">
    ...
    <section class="contact-section section-block" id="contact-section">
        ...
        <div class="design-elements">
            <img class="de-contact-1 elem-updown" src="/assets/image/design-elements/contact-element-1.png"
                alt="contact element 1">
            <img class="de-contact-2 elem-updown" src="/assets/image/design-elements/contact-element-2.png"
