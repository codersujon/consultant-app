<template lang="html">
    ...
    <section class="portfolio-section section-block" id="portfolio-section">
        <div class="container">
            ...
            <div class="row grid" data-aos="fade-up" data-aos-duration="2000">
                <div class="col-lg-4 col-md-6 grid-item programming">
                    <div class="box">
                        <img src="/assets/image/portfolio/portfolio-item-01.jpg" alt="portfolio image">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row item-content">
                                            <div class="col-xl-12">
                                                <img src="/assets/image/portfolio/portfolio_large_1.jpg"
                                                    alt="portfolio image">
                                            </div>
                                            <div class="col-xl-8">
                ...
                <div class="col-lg-4 col-md-6 grid-item development application">
                    <div class="box">
                        <img src="/assets/image/portfolio/portfolio-item-02.jpg" alt="portfolio image">
                        <div class="box-content">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row item-content">
                                            <div class="col-xl-12">
                                                <img src="/assets/image/portfolio/portfolio_large_2.jpg"
                                                    alt="portfolio image">
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="content-wrapper">
                ...
                <div class="col-lg-4 col-md-6 grid-item application programming design">
                    <div class="box">
                        <img src="/assets/image/portfolio/portfolio-item-03.jpg" alt="portfolio image">
                        <div class="box-content">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row item-content">
                                            <div class="col-xl-12">
                                                <img src="/assets/image/portfolio/portfolio_large_3.jpg"
                                                    alt="portfolio image">
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="content-wrapper">
                ...
                <div class="col-lg-4 col-md-6 grid-item design application">
                    <div class="box">
                        <img src="/assets/image/portfolio/portfolio-item-04.jpg" alt="portfolio image">
                        <div class="box-content">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row item-content">
                                            <div class="col-xl-12">
                                                <img src="/assets/image/portfolio/portfolio_large_4.jpg"
                                                    alt="portfolio image">
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="content-wrapper">
                ...
                <div class="col-lg-4 col-md-6 grid-item programming design">
                    <div class="box">
                        <img src="/assets/image/portfolio/portfolio-item-05.jpg" alt="portfolio image">
                        <div class="box-content">
                            <span class="category">Programming</span>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row item-content">
                                            <div class="col-xl-12">
                                                <img src="/assets/image/portfolio/portfolio_large_5.jpg"
                                                    alt="portfolio image">
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="content-wrapper">
                ...
                <div class="col-lg-4 col-md-6 grid-item development design">
                    <div class="box">
                        <img src="/assets/image/portfolio/portfolio-item-06.jpg" alt="portfolio image">
                        <div class="box-content">
                            <span class="category">Development</span>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row item-content">
                                            <div class="col-xl-12">
                                                <img src="/assets/image/portfolio/portfolio_large_6.jpg"
                                                    alt="portfolio image">
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="content-wrapper">
        ...
        <div class="design-elements">
            <img class="de-portfolio-1 elem-updown" src="/assets/image/design-elements/portfolio-element-1.png"
                alt="portfolio element 1">
            <img class="de-portfolio-2 elem-updown" src="/assets/image/design-elements/portfolio-element-2.png"
